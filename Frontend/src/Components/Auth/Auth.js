...
const Auth = (props) => {
    ...
    const s1 = "mx-2 px-9 py-2 font-semibold rounded-full shadow-sm text-white-900 bg-purple hover:drop-shadow-md hover:opacity-80 cursor-pointer";
    useEffect(() => {
                    ...
                    >
                        <fieldset className="border border-solid border-gray-300 px-12 py-5">
                            ...
                            {auth === 0 ? <><fieldset className="border border-solid border-gray-300 px-7 py-5 pb-7">
                                ...
                                :
                                <><div><label className="font-semibold  leading-8">User Mobile Number:<font color="red">*</font></label>
                                    <input
                                        className="w-full p-3 text-md border border-silver rounded"
                                        type="number"
