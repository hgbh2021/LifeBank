        ...
        <>
            <nav className="p-3 bg-white-900 sticky top-0 z-10 dark:bg-gray-bg">
                <div className="flex items-center justify-between">
                    <Link to="/">
                        <div className="flex items-center justify-between">
                            <img
                                ...
                                src={"http://t2.gstatic.com/images?q=tbn:ANd9GcRRfKDOS9q_E8od8jgnkdGQ-u8Tb6RbFOtdNWHPbDob6AWjgJB5"}
                                draggable={false}
                                alt="Your Company"
                            />
                    ...
                    <div className="flex items-center justify-between">
                        <>
                            <DropDown title="About Us" children={["About LifeBank", "Contact Us"]} links={[ "/about", "/contactUs"]}></DropDown>
                            {props.logIn ? (
                                <>
                                    <Link
                                ...
                                <>
                                    <DropDown title="request Blood" children={["Patient Login/Register", "Blood Bank Directory"]} links={["/register/patient", "/bloodDirect"]}></DropDown>
                            ...
                            <button
                                className="mx-2 px-3 py-2 rounded-full hover:shadow-lg hover:bg-white-300 "
                                onClick={() => {
                            ...
                            >
                                <i
                                    className={`dark:text-white-900 fa-solid fa-lg fa-${theme == 0 ? "moon" : "sun"
                                        }`}
                                ></i>
                            </button>
                        </>
