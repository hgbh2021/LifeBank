                    ...
                    <tbody>
                        {camps.map((e) =>
                            <tr>
                                ...
                                <td className="border p-3"><span className="border px-4 py-2 rounded-md text-blood cursor-pointer hover:bg-purple hover:text-white-900" onClick={() => register(e._id)}>Register</span></td>
                            </tr>
                        )}
                    </tbody>
                </table>
